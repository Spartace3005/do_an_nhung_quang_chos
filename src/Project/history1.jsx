...
const History1 = () => {
  return (
    <div className="historyLine1">
      <div className="title">SENSOR MEASUREMENT HISTORY OF DHT11-1</div>
      ...
      <div className="body">
        ...
        <div className="time-content">01-50-30</div>
        <div className="temp-content">40</div>
        <div className="humi-content">50</div>
      </div>
    </div>
  );
};
